    ...
    try:
        ...
        if feature == "General AI" or feature == "Everything AI":
            system_prompt = (
                ...
                "Pro plan: 120 credits per month, faster processing, higher-quality output — auto-expires after 1 month, reverts to Free.\n"
                "Heavy Pro plan: 210 credits per month, ultra-fast processing, ultra-quality output, built for production workloads — auto-expires after 1 month, reverts to Free.\n\n"
