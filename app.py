    ...
    try:
        ...
        if feature == "General AI" or feature == "Everything AI":
            system_prompt = (
                ...
                "Free plan: 7 credits/day, full access to all features, lifetime access, never expires.\n"
                "Pro plan: 300 credits per month, faster processing, higher-quality output — auto-expires after 1 month, reverts to Free.\n"
                "Heavy Pro plan: 500 credits per month, ultra-fast processing, ultra-quality output, built for production workloads — auto-expires after 1 month, reverts to Free.\n\n"
